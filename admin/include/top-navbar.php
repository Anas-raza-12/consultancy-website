		...
		<!-- <ul class="navbar-nav ms-auto">
			...
			<li class="nav-item dropdown ms-lg-2">
				...
				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
					...
					<a class="dropdown-item" href="signout.php"><i class="align-middle me-1 fas fa-fw fa-arrow-alt-circle-right"></i> Sign out</a>
				</div>
			</li>
		</ul> -->
		<ul class="navbar-nav ms-auto">
			<li class="nav-item dropdown ms-lg-2">
				<!-- Updated to logout icon -->
				<a class="nav-link position-relative" href="signout.php">
					<i class="align-middle fas fa-sign-out-alt"></i> <!-- Changed to a logout icon -->
				</a>
			</li>
		</ul>
	</div>
